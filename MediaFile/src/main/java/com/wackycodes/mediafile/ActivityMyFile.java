...
import com.wackycodes.mediafile.listener.MediaType;
...
import com.wackycodes.mediafile.permission.ActivityPermission;
...
public abstract class ActivityMyFile extends ActivityPermission implements MediaType {
    ...
    private ModelImage getImageFile(Uri uri, ModelImage modelImage) {
        ...
        try {
            if (uri == null && modelImage.getBitmap() != null) {
                uri = MyFileUtil.getImageUriFromBitmap(this, modelImage.getBitmap());
...
//            final Uri imageUri = data.getData();
    ...
    private ModelVideo getVideoFile(Uri uri) {
        ...
        // OI FILE Manager
        modelVideo.setVideoFullPath(uri != null ? uri.getPath() : null);
        // MEDIA GALLERY
