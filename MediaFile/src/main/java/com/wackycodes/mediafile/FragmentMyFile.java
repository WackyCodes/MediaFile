...
import com.wackycodes.mediafile.permission.FragmentPermission;
...
public class FragmentMyFile extends FragmentPermission {
    public FragmentMyFile() {
    }

    public FragmentMyFile(Context context) {
        super(context);
    }
